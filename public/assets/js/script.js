...
// notification warga berhasil
const tambahWargaSukses = $(".flash-message").data(
"flash-message-wargas"
);
if (tambahWargaSukses) {
setMessage(tambahWargaSukses, "success");
}
const deleteWarga = $(".flash-message").data(
"delete-wargas"
);
if (deleteWarga) {
setMessage(deleteWarga, "success");
}
const editWarga = $(".flash-message").data(
    "edit-wargas"
);
if (editWarga) {
    setMessage(editWarga, "success");
}

// notification pengaduan berhasil
// const tambahPengaduan = $(".flash-message").data(
// "flash-message-pengaduan"
// );
// if (tambahPengaduan) {
...
const tambahPengaduan = $(".flash-message").data(
"flash-message-pengaduan");
console.log("Flash Message dari JavaScript:", tambahPengaduan);

if (tambahPengaduan) {
setMessage(tambahPengaduan, "success");
}

const deletePengaduan = $(".flash-message").data(
"flash-message-pengaduan"
);
if (deletePengaduan) {
